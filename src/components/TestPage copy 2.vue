...
export default {
    ...
    methods: {
        ...
        loadRandomQuestions() {
            let shuffled = this.shuffleArray([...this.questions]).slice(0, 20);
            this.displayedQuestions = shuffled.map(q => ({
                ...q,
                options: this.shuffleArray([...q.options]) // Variantlarni ham aralashtiramiz
            }));
        },
        closeResultPopup() {
        ...
        submitTest() {
            ...
            savedResults.push(this.testResult);
